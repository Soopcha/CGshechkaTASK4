...
import static com.cgvsu.math.vector.Vector3.vertexToPoint2;
...
public class RenderEngine {
    ...
    public static void render(
        ...
        for (int polygonInd = 0; polygonInd < nPolygons; ++polygonInd) {
            ...
            ArrayList<Vector2> resultPoints1 = new ArrayList<>();
            for (int vertexInPolygonInd = 0; vertexInPolygonInd < nVerticesInPolygon; ++vertexInPolygonInd) {
                ...
                Vector2 resultPoint2 = vertexToPoint2(transformedVertex, width, height);
                resultPoints1.add(resultPoint2);
            }
            ...
            for (int vertexInPolygonInd = 1; vertexInPolygonInd < nVerticesInPolygon; ++vertexInPolygonInd) {
                graphicsContext.strokeLine(
                        resultPoints1.get(vertexInPolygonInd - 1).getX(),
                        resultPoints1.get(vertexInPolygonInd - 1).getY(),
                        resultPoints1.get(vertexInPolygonInd).getX(),
                        resultPoints1.get(vertexInPolygonInd).getY());
            }
//
//            if (nVerticesInPolygon > 0)
//                graphicsContext.strokeLine(
//                        resultPoints1.get(nVerticesInPolygon - 1).getX(),
//                        resultPoints1.get(nVerticesInPolygon - 1).getY(),
//                        resultPoints1.get(0).getX(),
//                        resultPoints1.get(0).getY());
//
        }
    }
